...
export default class Level1 extends Scene {
  ...
  private tutorial: Npc;

  private talkToTutorial: boolean;

  private talkedToTutorial: boolean;

  private tutorialStep2: Npc;

  private talkToTutorialStep2: boolean;

  private talkToFiller: boolean;

  private fillerNpc: Npc;
